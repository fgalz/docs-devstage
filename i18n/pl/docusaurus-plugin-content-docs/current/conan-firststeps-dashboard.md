...
Po przejściu przez ten poradnik, bez problemu będziesz mógł efektywnie zarządzać swoim serwerem i szybko znajdować wszystkie potrzebne opcje i funkcje. Otrzymasz tu uporządkowany przegląd, który krok po kroku pomoże Ci zapoznać się z administracją serwera i celowo poszerzać swoją wiedzę. Dzięki temu zapewnisz, że Twój **serwer gier Conan Exiles** będzie optymalnie dopasowany do Twoich potrzeb i wykorzystasz dostępne możliwości w 100%.
...
W panelu głównym masz też opcję uruchomienia, zatrzymania lub restartu serwera, co daje Ci pełną kontrolę nad jego działaniem. Ponadto możesz uzyskać dostęp do konsoli na żywo, aby na bieżąco śledzić stan serwera i w razie potrzeby podjąć natychmiastowe działania.

### Statystyki

W zakładce **Statystyki** otrzymujesz kompleksowy przegląd obciążenia Twojego serwera. Znajdziesz tu dane dotyczące różnych aspektów, takich jak obciążenie slotów, CPU i pamięci. Możesz przeglądać te dane dla różnych okresów, np. ostatnich **60 minut, 24 godzin, 3 dni, 7 dni** lub **30 dni**.
...
**Konsola na żywo** oferuje podgląd w czasie rzeczywistym wszystkich aktualnych zdarzeń na Twoim serwerze. Zobaczysz tu informacje o działaniach graczy oraz ewentualne komunikaty o błędach i systemowe. Ten przegląd pozwala mieć pełny obraz tego, co dzieje się na serwerze i wykrywać problemy na wczesnym etapie.
...
Twój serwer był chwilowo offline i nie wiesz dlaczego? Sprawdzenie dziennika zdarzeń i plików logów nic nie wyjaśniło? Możliwe, że problem nie leży bezpośrednio po stronie Twojego serwera, lecz systemu hostującego, na którym działa.
...
W tej sekcji znajdziesz historię przerw w działaniu systemu hostującego, na którym działa Twój serwer gier. Więcej informacji i aktualny status usługi znajdziesz na naszej nowej [stronie statusu](https://status.zap-hosting.com/).
...
Oprócz serwerów gier oferujemy też 10 wliczonych baz danych. Bazy te są potrzebne np. gdy dane muszą być przechowywane w bazie. W zakładce **Bazy danych** możesz utworzyć bazę i zobaczyć dane dostępowe. Masz też opcję włączenia kopii zapasowej bazy oraz importu istniejących backupów.
...
Domyślnie dla naszych serwerów gier zapewniamy 10 GB przestrzeni na kopie zapasowe na serwerze storage. Jeśli potrzebujesz więcej miejsca, możesz dokupić upgrade. Dzięki temu masz pewność, że zawsze masz wystarczająco dużo miejsca na backupy i dostęp do starszych kopii, gdy zajdzie taka potrzeba.
